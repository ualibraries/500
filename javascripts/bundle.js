(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["reformation-500-omeka-theme"] = factory();
	else
		root["reformation-500-omeka-theme"] = factory();
})(this, function() {
...
var _exhibitMenu = __webpack_require__(7);

var _itemFilesList = __webpack_require__(8);

var _fileAllMeta = __webpack_require__(15);

var _disableStylesheets = __webpack_require__(18);

document.addEventListener('DOMContentLoaded', function () {
  (0, _fonts.loadFonts)();
  (0, _exhibitMenu.exhibitMenu)();
  (0, _itemFilesList.itemFilesList)();
  (0, _fileAllMeta.fileAllMeta)();
  (0, _disableStylesheets.disableStylesheets)();
});
...
function close(nav) {
  ...
  var overlay = document.querySelector('.exhibit-menu-links-overlay');
...
function toggle() {
  var nav = document.getElementById('exhibit-menu-links');
...
function handleOutsideNavClick(event) {
  var nav = document.getElementById('exhibit-menu-links');
  var navToggle = document.getElementById('exhibit-menu-toggle');
...
exports.exhibitMenu = exhibitMenu;
...
exports.itemFilesList = undefined;

var _masonryLayout = __webpack_require__(9);

var _masonryLayout2 = _interopRequireDefault(_masonryLayout);

var _imagesloaded = __webpack_require__(14);
...
function itemFilesList() {
  var container = document.querySelector('.item-files-list');

  if (!container) {
    return;
  }

  (0, _imagesloaded2.default)(container, function () {
    var masonry = new _masonryLayout2.default(container, {
...
exports.itemFilesList = itemFilesList;
...
exports.fileAllMeta = undefined;

var _lodash = __webpack_require__(2);

function fileAllMeta() {
  var elements = document.querySelectorAll('.item-file-all-metadata-toggle');
...
function showMeta(element) {
  ...
  // Make a new modal
  var metaContainer = element.target.parentNode.querySelector('.item-file-all-metadata');
...
exports.fileAllMeta = fileAllMeta;
...
exports.disableStylesheets = undefined;

var _lodash = __webpack_require__(2);

// Array, stylesheets to disable
var disabled = ['plugins/ExhibitBuilder/views/shared/exhibit_layouts/gallery/layout.css'];

// Disable stylesheets listed in the `disabled` array
function disableStylesheets() {
  (0, _lodash.forEach)(document.styleSheets, function (stylesheet) {
...
exports.disableStylesheets = disableStylesheets;
